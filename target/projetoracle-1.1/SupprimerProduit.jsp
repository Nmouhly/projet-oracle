...
<body>
<div class="container">
    <form id="produitForm1" action="${pageContext.request.contextPath}/ProduitServlet" method="post" onsubmit="return validateForm()">
        <label>Entrer l'ID_Produit du produit que vous voulez supprimer: </label>
