...
<body>
<div class="container">
    <form id="clientForm1" action="${pageContext.request.contextPath}/ClientServlet" method="post" onsubmit="return validateForm()">
        <label>Entrer l'ID_Client du client que vous voulez supprimer: </label>
